...
Blockly.defineBlocksWithJsonArray([  // BEGIN JSON EXTRACT
    {
        ...
        "type": "gdl_3d_prism_",
        "message0": "prism_       height %1 points (x, y, s) %2",
        "args0": [
            {
                "type": "input_value",
                "name": "H",
        ...
        "type": "gdl_2d_coordinate_status",
        "message0": "x %1 y %2 s %3",
        "args0": [
            {
                "type": "input_value",
                "name": "X",
...
Blockly.GDL['gdl_xys_list'] = function (block) {
    // Create a list with any number of elements of any type.
    var elements = new Array(block.itemCount_);
    for (var i = 0; i < block.itemCount_; i++) {
        elements[i] = Blockly.GDL.valueToCode(block, 'ADD' + i,
...
Blockly.GDL['gdl_3d_prism_'] = function (block) {
    var value_h = Blockly.GDL._numValueToCode(block, 'H', Blockly.GDL.ORDER_COMMA);
